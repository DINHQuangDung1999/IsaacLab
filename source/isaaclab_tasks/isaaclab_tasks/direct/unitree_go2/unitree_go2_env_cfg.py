...
class UnitreeGo2FlatEnvCfg(DirectRLEnvCfg):
    ...
    # reward scales
    lin_vel_reward_scale = 3*1.0
    yaw_rate_reward_scale = 3*0.5
    z_vel_reward_scale = -2.0
    ang_vel_reward_scale = -0.05
    joint_torque_reward_scale = -2e-5
    joint_power_reward_scale = -2e-5
    joint_accel_reward_scale = -2.5e-7
    action_rate_reward_scale = -0.01
    action_smoothness_reward_scale = -0.01
    body_height_reward_scale = 2*-1.0
    feet_air_time_reward_scale = 2*0.5
    undesired_contact_reward_scale = -1.0
    flat_orientation_reward_scale = -0.2
    ...
    # body_height_reward_scale = -0.2
    # feet_air_time_reward_scale = 2*0.5
    # undesired_contact_reward_scale = -1.0
    # flat_orientation_reward_scale = -5e-3
